            ...
            <Container>
                ...
                <Row className="">
                    ...
                    <Col className="col-lg-3 col-12 mt-3">
                        ...
                        and more." link="https://github.com/ad-world/financial_tracker"/>
                    </Col>
                    <Col className="col-lg-3 col-12 mt-3">
                        ...
                        , and summer breaks, and a countdown to graduation." link="http://homeoftheleopards.org/"/>
                    </Col>
                    <Col className="col-lg-3 col-12 mt-3">
                        ...
                        technologies like React and Firebase." link="https://aryaman.dev/"/>
                    </Col>
                </Row>
            </Container>
        </Container>
